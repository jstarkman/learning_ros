...
int main(int argc, char** argv)
{
  ...
  ros::NodeHandle nh;
  ros::Publisher pub1 = nh.advertise<std_msgs::msg::Float64>("/planar_3rbot/joint1_position_controller/command", 1);
  ros::Publisher pub2 = nh.advertise<std_msgs::msg::Float64>("/planar_3rbot/joint2_position_controller/command", 1);
  ros::Publisher pub3 = nh.advertise<std_msgs::msg::Float64>("/planar_3rbot/joint3_position_controller/command", 1);
  ...
  jointspace_path.push_back(g_q_vec);
