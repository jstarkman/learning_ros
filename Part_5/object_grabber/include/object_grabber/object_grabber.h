...
private:
  ...
  ros::ServiceClient
      manip_properties_client_;  // =
                                 // n.serviceClient<object_manipulation_properties::objectManipulationQuery>("object_manip_query_svc");
  ...
  int object_code_;
  std_msgs::msg::Bool grasp_, release_;
  ...
  // int32 PLAN_MOVE_TO_GRASP_POSE  =2   #expects parameters of current_object_pose, object_ID, grasp_option,
  // approach_option
  ...
  // int32 PLAN_WITHDRAW_FROM_OBJECT = 7 #with object grasp released, perform departure from object using specified
  // depart strategy
  ...
  // int32 SET_SPEED_FACTOR = 10    #use arg speed_factor to change time scale of trajectory plan; larger than 1.0-->
  // slower
