                            ...
                            geometry_msgs::PoseStamped &approach_pose, geometry_msgs::PoseStamped &depart_pose)
{
  ...
  ros::ServiceClient manip_query_client =
      nh.serviceClient<object_manipulation_properties::objectManipulationQuery>("object_manip_query_svc");
  ...
  manip_query_srv.request.query_code =
