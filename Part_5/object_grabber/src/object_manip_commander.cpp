...
ArmMotionCommander::ArmMotionCommander(ros::NodeHandle* nodehandle)
  : nh_(*nodehandle), cart_move_action_client_("cart_move_action_server", true)
{
...
int ArmMotionCommander::request_tool_pose_wrt_base(void)
{
  ...
  ROS_INFO("origin w/rt base = %f, %f, %f ", tool_pose_stamped_.pose.position.x, tool_pose_stamped_.pose.position.y,
