...
const double g_qdot_max_vec[] = { 2.16, 2.16, 3.15, 3.2, 3.2, 3.2 };  // values per URDF ur10.urdf.xacro in
                                                                      // ur_description
...
private:
  ...
  void compute_q5_solns(Eigen::Vector3d p_des, std::vector<double> q1_solns, std::vector<double> &q5_solns_1a,
                        std::vector<double> &q5_solns_1b);
  ...
  bool compute_q6_solns(Eigen::Matrix3d target_R61, std::vector<double> q5_solns, std::vector<double> &q6_solns);
  ...
  bool solve_2R_planar_arm_elbow_angs(double x_des, double y_des, double L1, double L2, vector<double> &q_elbow_solns);
  bool solve_2R_planar_arm_shoulder_ang(double x_des, double y_des, double L1, double L2, double q_elbow,
                                        double &q_shoulder);
  bool solve_2R_planar_arm(double x_des, double y_des, double L1, double L2, vector<double> &q_shoulder_solns,
