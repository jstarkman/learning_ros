...
private:
  ...
  actionlib::SimpleActionClient<cartesian_planner::cart_moveAction>
  ...
  void doneCb_(const actionlib::SimpleClientGoalState& state, const cartesian_planner::cart_moveResultConstPtr& result);
...
public:
  ...
  geometry_msgs::PoseStamped get_tool_pose_stamped(void)
  {
