...
void myCallbackVelocity(
    const std_msgs::msg::Float64::SharedPtr message_holder) {
...
int main(int argc, char **argv) {
  ...
  auto my_subscriber_1 = node->create_subscription<std_msgs::msg::Float64>(
      "velocity", myCallbackVelocity, rmw_qos_profile_default);
  auto my_subscriber_2 = node->create_subscription<std_msgs::msg::Float64>(
      "vel_cmd", myCallbackVelCmd, rmw_qos_profile_default);
