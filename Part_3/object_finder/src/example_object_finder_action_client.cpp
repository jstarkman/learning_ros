                        ...
                        const object_finder::objectFinderResultConstPtr& result)
{
  ...
  else if (g_found_object_code == object_finder::objectFinderResult::OBJECT_FOUND)
  {
    ...
    ROS_INFO("got quaternion x,y,z, w = %f, %f, %f, %f", g_perceived_object_pose.pose.orientation.x,
             g_perceived_object_pose.pose.orientation.y, g_perceived_object_pose.pose.orientation.z,
...
{
  ros::init(argc, argv, "example_object_finder_action_client");
  ros::NodeHandle nh;

  actionlib::SimpleActionClient<object_finder::objectFinderAction> object_finder_ac("object_finder_action_service",
                                                                                    true);
  ...
  if (g_found_object_code == object_finder::objectFinderResult::OBJECT_FOUND)
  {
    ...
    surface_height = g_perceived_object_pose.pose.position.z;
